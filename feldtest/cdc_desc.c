 ...
 */
ALIGNED(4) const uint8_t USB_cdc_DeviceDescriptor[] = {
 ...
 */
ALIGNED(4) const uint8_t USB_cdc_DeviceQualifier[] = {
 ...
 */
ALIGNED(4) uint8_t USB_cdc_FsConfigDescriptor[] = {
	/* Configuration 1 */
 ...
 * All Descriptors (Configuration, Interface, Endpoint, Class, Vendor)
 */
ALIGNED(4) uint8_t USB_cdc_HsConfigDescriptor[] = {
	/* Configuration 1 */
	USB_CONFIGURATION_DESC_SIZE,			/* bLength */
	USB_CONFIGURATION_DESCRIPTOR_TYPE,		/* bDescriptorType */
	WBVAL(									/* wTotalLength */
 ...
 */
ALIGNED(4) const uint8_t USB_cdc_StringDescriptor[] = {
