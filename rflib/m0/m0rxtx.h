...
/* special value for ACK SHM register: this is set when new RX data is ready */
#define ACK_NOTIFY_RX 0xFFFFFFFF
/* special value for ACK SHM register: TX is done */
...
volatile uint32_t *const m0_mode = (volatile uint32_t *const) 0x20002030;
