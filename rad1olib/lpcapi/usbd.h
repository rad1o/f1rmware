...
struct _packed _USB_SETUP_PACKET
{
...
struct _packed _USB_DEVICE_DESCRIPTOR
{
...
struct _packed _USB_DEVICE_QUALIFIER_DESCRIPTOR
{
...
struct _packed _USB_CONFIGURATION_DESCRIPTOR
{
  uint8_t  bLength; /**< Size of this descriptor in bytes */
...
struct _packed _USB_IAD_DESCRIPTOR
{
  uint8_t  bLength; /**< Size of this descriptor in bytes*/
...
struct _packed _USB_INTERFACE_DESCRIPTOR
{
  uint8_t  bLength; /**< Size of this descriptor in bytes*/
...
struct _packed _USB_ENDPOINT_DESCRIPTOR
{
  uint8_t  bLength; /**< Size of this descriptor in bytes*/
...
struct _packed _USB_STRING_DESCRIPTOR
{
  uint8_t  bLength; /**< Size of this descriptor in bytes*/
...
struct _packed _USB_COMMON_DESCRIPTOR
{
  uint8_t  bLength; /**< Size of this descriptor in bytes*/
...
struct _packed _USB_OTHER_SPEED_CONFIGURATION
{
  uint8_t  bLength; /**< Size of descriptor*/
