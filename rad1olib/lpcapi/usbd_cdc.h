...
struct _packed _CDC_HEADER_DESCRIPTOR{
...
struct _packed _CDC_CALL_MANAGEMENT_DESCRIPTOR {
  uint8_t  bFunctionLength;                      /* size of this descriptor in bytes */
  uint8_t  bDescriptorType;                      /* CS_INTERFACE descriptor type */
...
struct _packed _CDC_ABSTRACT_CONTROL_MANAGEMENT_DESCRIPTOR {
  uint8_t  bFunctionLength;                      /* size of this descriptor in bytes */
  uint8_t  bDescriptorType;                      /* CS_INTERFACE descriptor type */
...
struct _packed _CDC_UNION_DESCRIPTOR {
  uint8_t  bFunctionLength;                      /* size of this descriptor in bytes */
  uint8_t  bDescriptorType;                      /* CS_INTERFACE descriptor type */
...
/* (usbcdc11.pdf, 5.2.3.8) */
struct _packed _CDC_UNION_1SLAVE_DESCRIPTOR {
...
/* (usbcdc11.pdf, 6.2.13) */
struct _packed _CDC_LINE_CODING {
